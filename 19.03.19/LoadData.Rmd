...
```{r read config data, eval=FALSE, include=FALSE}
  ...
  basePath <- "G:/Hanna/SimulationTree/selection_false/ANOVA/translMethod_random/"
...
```{r Summarize Out, 6 params + pre conditions, eval=FALSE, include=FALSE}
# CAUTION: Take reducedConfig and put it in new variable
