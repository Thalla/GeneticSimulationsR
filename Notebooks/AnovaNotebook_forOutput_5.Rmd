...
```{r WEKA, eval=FALSE, include=FALSE}
conf <- config

# normal data
mainData <- data.frame(translationtype = conf$translationType, geneNumb = conf$geneNumb, initAaNumb = conf$initAaNumb, similarAars = conf$similarAars, aarsLifeticksStartValue = conf$aarsLifeticksStartValue, livingAarsStartNumb = conf$livingAarsStartNumb, livingAarsSeed = conf$livingAarsSeed, mean = conf$mean)
...
nominalMean <- conf$mean
nominalMean[nominalMean <= 0.02] <- "z"
nominalMean[nominalMean <= 0.04 & nominalMean >0.02] <- "a"
nominalMean[nominalMean <= 0.06 & nominalMean >0.04] <- "b"
nominalMean[nominalMean <= 0.08 & nominalMean >0.06] <- "c"
nominalMean[nominalMean <= 0.1 & nominalMean >0.08] <- "d"
nominalMean[nominalMean <= 0.12 & nominalMean >0.1] <- "e"
nominalMean[nominalMean <= 0.14 & nominalMean >0.12] <- "f"
nominalMean[nominalMean <= 0.16 & nominalMean >0.14] <- "g"
nominalMean[nominalMean <= 0.18 & nominalMean >0.16] <- "h"
nominalMean[nominalMean <= 0.2 & nominalMean >0.18] <-"i"
nominalMean[nominalMean <= 0.22 & nominalMean >0.2] <- "j"
nominalMean[nominalMean <= 0.24 & nominalMean >0.22] <- "k"
nominalMean[nominalMean <= 0.26 & nominalMean >0.24] <- "l"
nominalMean[nominalMean <= 0.28 & nominalMean >0.26] <- "m"
nominalMean[nominalMean <= 0.3 & nominalMean >0.28] <- "n"
conf <- cbind(conf, nominalMean)
...
fwrite(mainData, "C:/Users/feroc/MagentaCLOUD/MasterThesis/WEKA csv/livingDataNomDetailed.csv")
fwrite(mainData, "C:/Users/feroc/MagentaCLOUD/MasterThesis/WEKA csv/livingDataNomDetailedLetters.csv")
fwrite(mainData, "C:/Users/feroc/MagentaCLOUD/MasterThesis/WEKA csv/livingDataNomDetailedFirstOneRCorrectInstancesDeleted.csv")

fwrite(mainData, "C:/Users/feroc/MagentaCLOUD/MasterThesis/WEKA csv/wekaNominal02stepsAllData.csv")
...
qqnorm(config6FactL2029Out0120RandAndMaxL2029Out0110$mean, main = "Fitness")
qqline(config6FactL2029Out0120RandAndMaxL2029Out0110$mean)
